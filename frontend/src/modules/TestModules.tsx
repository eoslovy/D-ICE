...
export default function TestModules(props: TestModulesProps) {
    ...
    // --- State for POTG ---
    const [isPotgRecording, setIsPotgRecording] = useState<boolean>(
        potgManager.getIsRecording()
    );
    ...
    useEffect(() => {
        ...
        const handleRecordingStopped = async () => {
            ...
            try {
                ...
                console.error(
                    "[TestModules] Error getting stored blob:",
                    error
                );
        ...
        return () => {
            ...
            if (potgVideoUrl) {
                ...
                console.log(
                    "[TestModules] Revoked video URL on cleanup:",
                    potgVideoUrl
                );
            }
        };
    ...
    const sendhttpRequest = () => {
        ...
        fetch(url, {
            ...
            .then((response) => {
                ...
                throw new Error(
                    "Received non-JSON response from /rooms endpoint"
                );
            })
            .then((data) => {
                ...
                if (data && typeof data.roomCode === "string") {
                    ...
                    setHttpError(
                        "Response did not contain a valid 'roomCode'."
                    );
                }
            })
            .catch((error) => {
    ...
    const handleTriggerEffect = () => {
        props.onTriggerParticleEffect();
    };
    const handleTriggerSpriteShowcase = () => {
        props.onTriggerSpriteShowcase();
    };
    ...
    // --- POTG Handlers ---
    const handleStartCanvasRecording = async () => {
        // Renamed
        setPotgError(null);
    ...
    const handleSendRawMessage = () => {
        ...
        try {
            ...
            console.log(
                "[TestModules] Sent Raw WebSocket Message:",
                messageObject
            );
        } catch (error: any) {
                ...
                <div style={consoleStyle}>
                    ...
                    >
                        ...
                        <button
                            ...
                            style={!roomId ? disabledButtonStyle : buttonStyle}
                            disabled={!roomId}
                        >
                            Connect
                        </button>
                    ...
                    <div style={{ marginBottom: "10px" }}>
                        <button
                            ...
                            style={
                                isLoading ? disabledButtonStyle : buttonStyle
                            }
                            disabled={isLoading}
                        >
                    ...
                    <div style={sectionStyle}>
                        <button onClick={testAggregation} style={buttonStyle}>
                            Test Aggregation
                        </button>
                    </div>
                    ...
                    >
                        <h2 style={{ fontSize: "14px", marginBottom: "8px" }}>
                            POTG Recording (Canvas)
                        </h2>
                        {/* --- Updated onClick handler --- */}
                        <button
                            onClick={handleStartCanvasRecording}
                            style={
                                isPotgRecording
                                    ? disabledButtonStyle
                                    : buttonStyle
                            }
                            disabled={isPotgRecording}
                        >
                            Start Record
                        </button>
                        <button
                            onClick={handleStopPotgRecording}
                            style={
                                !isPotgRecording
                                    ? disabledButtonStyle
                                    : buttonStyle
