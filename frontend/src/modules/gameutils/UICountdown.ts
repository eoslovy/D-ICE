export class UICountdown {
    ...
    constructor(
        ...
        this.countdownText = this.phaserScene.add
            .text(x, y, "", {
        ...
        this.phaserScene.load.audio(
            "countdownSound",
            "assets/sounds/SFX_UI_Countdown_Blow_1.wav"
        );
        ...
        this.phaserScene.load.audio(
            ...
            "assets/sounds/SFX_UI_Countdown_End_1.wav"
        );
        this.phaserScene.load.once(
            "filecomplete-audio-countdownFinishedSound",
            () => {
                this.countdownFinishedSound = this.phaserScene.sound.add(
                    "countdownFinishedSound"
                );
            }
        );
    ...
    healthCheck() {
        if (!this.phaserScene) {
            console.warn(
                "[UICountdown] Phaser scene is not active or not defined"
            );
            return false;
        }
