...
export class Wirewalk extends Scene {
    ...
    preload() {
        ...
        this.load.audio('wirewalk_fail', 'assets/wirewalk/TECHINTERFACEComputerBeepsLong02.wav');
        this.load.audio('wirewalk_btn', 'assets/wirewalk/VOCALEVILImpactHitOOOF03.wav');
    ...
    create() {
        ...
        this.add.graphics()
            .fillGradientStyle(0x87CEEB, 0x4682B4, 0x4682B4, 0x00008B, 1)
    ...
    startGame() {
        ...
        this.buttonLeft = this.add.sprite(buttonX1, buttonY, 'btn_blue')
            .setOrigin(0.5, 0.5)
            .setInteractive()
            .on('pointerdown', () => {
        ...
        this.buttonLeftText = this.add.text(buttonX1, buttonY, '◀', {
            fontSize: '64px',
            fontFamily: 'Arial',
            color: '#ffffff',
            align: 'center',
        ...
        this.buttonRight = this.add.sprite(buttonX2, buttonY, 'btn_blue')
            .setOrigin(0.5, 0.5)
            .setInteractive()
            .on('pointerdown', () => {
                this.wirewalk_btn?.play();
                ...
                if (!this.btn_right_tween || !this.btn_right_tween.isPlaying()) {
        ...
        this.buttonRightText = this.add.text(buttonX2, buttonY, '▶', {
            fontSize: '64px',
            fontFamily: 'Arial',
            color: '#ffffff',
            align: 'center',
    ...
    update(time: number, delta: number) {
        ...
        if (Math.abs(this.tiltValue) > this.tiltLimit) {
            const failText = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY, '안 돼!', {
                fontSize: '128px',
                fontFamily: 'Arial',
                color: '#ff0000',
                align: 'center',
        ...
        this.player.setRotation(this.tiltValue / this.tiltLimit * 90 * Math.PI / 180);
    }
}
