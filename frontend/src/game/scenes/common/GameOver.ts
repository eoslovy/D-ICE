...
export class GameOver extends Phaser.Scene {
    ...
    private showInitialScreen() {
        ...
        // 최종 점수
        this.add
            .text(width / 2, height * 0.4, `최종 점수: ${this.roundScore}`, {
                fontSize: "32px",
                color: "#ffffff",
                align: "center",
                fontFamily: "Jua",
        ...
        this.loadingText = this.add
            .text(width / 2, height * 0.5, "결과를 불러오는 중...", {
                fontSize: "24px",
                color: "#ffffff",
                align: "center",
                fontFamily: "Jua",
    ...
    private updateUI() {
        ...
        // 제목
        this.add
            .text(width / 2, height * 0.15, "게임 종료!", {
                fontSize: "48px",
                color: "#ffffff",
                align: "center",
                fontFamily: "Jua",
    ...
    private createRankGraph(x: number, y: number) {
        ...
        ranks.forEach((rank, index) => {
            ...
            // X축 라벨 (라운드 번호)
            this.add
                .text(pointX, y + graphHeight / 2 + 10, `R${index + 1}`, {
                    fontSize: "16px",
                    color: "#ffffff",
                    fontFamily: "Jua",
                })
        ...
        for (let i = 1; i <= 5; i++) {
            ...
            this.add
                .text(x - graphWidth / 2 - 10, labelY, `${i}위`, {
                    fontSize: "16px",
                    color: "#ffffff",
                    fontFamily: "Jua",
                })
        ...
        // 그래프 제목
        this.add
            .text(x, y - graphHeight / 2 - 20, "라운드별 순위 변화", {
                fontSize: "24px",
                color: "#ffffff",
                align: "center",
                fontFamily: "Jua",
